...
namespace HMesh
{
    ...
    public:
       ...
       // VertexID split_face_by_vertex(HalfEdgeID h);
        ...
        bool isEdgePartOfFace(HalfEdgeID h, FaceID f);

        bool isVertexPartOfFace(VertexID v, FaceID f);
    ...
    1.  For the two vertices adjacent to the edge, we generate a list of all their neighboring vertices. 
